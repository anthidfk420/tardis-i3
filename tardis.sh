...
# Installing packages
pacman_install () {
	pacman -S i3 dmenu polybar ttf-fira-code thunar materia-gtk-theme ttf-fira-sans sddm noto-fonts noto-fonts-cjk nitrogen wireplumber pipewire pipewire-pulse pavucontrol xfce4-terminal network-manager-applet chromium vim --noconfirm --needed
