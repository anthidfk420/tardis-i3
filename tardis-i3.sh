...
# Installing packages
pacman_install () {
	pacman -S i3 dmenu polybar ttf-fira-code arc-icon-theme lxappearance thunar materia-gtk-theme ttf-fira-sans sddm noto-fonts noto-fonts-cjk xwallpaper wireplumber pipewire pipewire-pulse pavucontrol xfce4-terminal network-manager-applet chromium vim --noconfirm --needed
...
wm_customise () {
	...
	mv $cwd/wallpapers /home/$selected_username/ 
	end_of_install
}
